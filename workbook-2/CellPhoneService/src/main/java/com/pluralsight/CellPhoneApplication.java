...
public class CellPhoneApplication {
    public static void main(String[] args) {
       ...
       com.pluralsight.CellPhone cellPhone1 = new com.pluralsight.CellPhone();
        com.pluralsight.CellPhone cellPhone2 = new com.pluralsight.CellPhone();
    ...
    public static void display(com.pluralsight.CellPhone phone) {
        System.out.println("\nCellPhone Details:");
